...
main();
/*** Promise.race() accepts the first settled promise (resolved or rejected) and ignores other late states but other promises continue executing regardless and logging these messages ***/
